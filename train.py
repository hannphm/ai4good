...
import config
from shap import generate_global_shap
...
def evaluate(y_true, y_pred):
    true_flare = y_true > config.FLARE_THRESHOLD
    pred_flare = y_pred > config.FLARE_THRESHOLD
    ...
    return {
        ...
        "auc": roc_auc_score(true_flare, y_pred)
    }
...
def main():
    ...
    for train_idx, test_idx in cv.split(X, y, groups):
        ...
        results.append(evaluate(y.iloc[test_idx],y_pred))
